...
- Manual timestamp mode is tab-local and starts off after a page load. **Continue** and **Project** sends are excluded because Quick Continue already renders their configured `{time}` placeholder itself.
