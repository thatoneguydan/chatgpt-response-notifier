...
- Makes definitive `COMPLETE_APPLIED`, `COMPLETE_NO_CHANGES`, `BLOCKED_HUMAN`, and `PLANNING_ACTIVE` states storage-authoritative: once observed, stale monitor writes cannot reopen the watchdog until a genuinely newer request begins.
