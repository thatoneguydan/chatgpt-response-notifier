...
test('status stabilizer and current timer owner share one document-start content script', () => {
  ...
  assert.deepEqual(entry.js, ['quick-continue-status-stabilizer.js', 'quick-continue-status-owner-v6.js']);
