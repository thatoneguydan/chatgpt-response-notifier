...
The repaired behavior and installer regression first reached exact green proof at `3737dfd0ba2cc040698b86b7ed6160230c6809af` / Glass run `34708809699`. The branch may have a later documentation-only roadmap checkpoint commit; issue #34, PR #33, and active-work #283 own the exact latest acceptance artifact identity so this roadmap does not create an endless self-referential source-commit cycle by rewriting itself after every candidate build.
